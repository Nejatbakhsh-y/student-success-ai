...
| G/S. cleaned ML dataset exists                                                 | data/processed/student_ml_clean.csv                                       | PASS                | NO                     |
| F. dataset inspection report exists                                            | reports/inspection/dataset_inspection_report.md                           | PASS                | YES                    |
| M. final project report exists                                                 | reports/final/final_project_report.md                                     | MISSING             | NO                     |
| X/L. saved tables exist                                                        | reports/tables/*.csv                                                      | MISSING             | Check individual files |
| X/L. saved figures exist                                                       | reports/figures/*.png, *.pdf, or *.jpg                                    | MISSING             | Check individual files |
| F. README contains Colab badge or Colab link                                   | README.md                                                                 | MISSING             | YES                    |
| N. README appears to include results/model discussion                          | README.md                                                                 | MISSING             | YES                    |
...
| Y/O. working tree is clean                                                     | git status --short                                                        | UNCOMMITTED CHANGES | N/A                    |
| Y/O. local commits pushed to GitHub                                            | git rev-list --count @{u}..HEAD                                           | UNPUSHED COMMITS: 1 | N/A                    |
